...
{
    internal class Tariffs : FinalValue
    {
        public void Exibition_tariffs() 
        {
            Console.WriteLine("============================================");
            Console.WriteLine("\nRegras tarifárias:");
            Console.WriteLine($"* Tarifa por minuto: A tarifa básica é de R$ {Preco_Minuto} por minuto.\r\nEste valor será multiplicado pelo número total de minutos que o cliente permaneceu estacionado.");
            Console.WriteLine("* Tarifa Fixa para Períodos Específicos: Se o tempo de uso total estiver entre 8 e 12 horas (equivalente a 480 a 720 minutos), o usuário paga um valor fixo de R$ 50,00.");
