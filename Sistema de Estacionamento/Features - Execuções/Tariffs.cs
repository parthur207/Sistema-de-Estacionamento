...
namespace Sistema_de_Estacionamento.Features___Execuções
{
    internal class Tariffs : FinalValue, IFeature_Parking
    {
        public void Exibition_tariffs()
        {
            ...
            Console.WriteLine($"\n* Exemplos Práticos: \n- Exemplo 1: Se o usuário utilizar o serviço por 6 horas (360 minutos), o valor para carros/caminhões será 360 * {taxa_CarroCaminhao} = R$ {taxa_CarroCaminhao*360}. Motos o valor será de R$ 360 * {taxa_Moto} = R$ {taxa_Moto * 360}");
            Console.WriteLine("- Exemplo 2: Para um período de 30 minutos, equivalente a 0,5 hora, ou 60 minutos, equivalente a 1 hora, ");
            Console.WriteLine($"- Exemplo 3: Com 13 horas de uso (780 minutos), o valor para carros/caminhões será 780 * {taxa_CarroCaminhao} = R$ {taxa_CarroCaminhao * 780}. Motos o valor será 360 * {taxa_Moto} = R$ {taxa_Moto * 360}");
            Console.WriteLine("============================================\n");
        }
    }
